...
for i=2:N
    if Y2(i)>50       
        R=[sigmaCamera 0 0 0 0 0 0 0 0;...
           0 10 0 0 0 0 0 0 0;...
           0 0 sigmaOd 0 0 0 0 0 0;...
           0 0 0 sigmaCamera 0 0 0 0 0;...
           0 0 0 0 10 0 0 0 0;...
           0 0 0 0 0 sigmaOd 0 0 0;...
           0 0 0 0 0 0 inf 0 0;...
           0 0 0 0 0 0 0 sigmaAngle 0;...
           0 0 0 0 0 0 0 0 sigmaOdAngle]; 
    else
        R=[sigmaCamera 0 0 0 0 0 0 0 0;...
           0 inf 0 0 0 0 0 0 0;...
           0 0 sigmaOd 0 0 0 0 0 0;...
    ...
    mPredict=mOpt(i-1,:)';
    mOd=mOpt(i-1,:)'+[Vx(i-1) Vy(i-1) w(i-1)]';
    Pk=A*[P(i-1,1,1), P(i-1,1,2), P(i-1,1,3);...
        P(i-1,2,1), P(i-1,2,2), P(i-1,2,3);...
        P(i-1,3,1), P(i-1,3,2), P(i-1,3,3)]*A+Q;
    K=Pk*C'*inv(C*Pk*C'+R);
    Z=[X1(i) 0 mOd(1) Y1(i) Y2(i) mOd(2) 0 angle(i) mOd(3)]';
    KM=K*(Z-C*mPredict);
    mOpt(i,:)=mPredict+KM;
    P(i,1:3,1:3)=(eye(3)-K*C)*Pk;
